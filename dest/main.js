...
$('.categorybtn__default').click(function () {
    $('.dropdown__list').toggleClass('active2');
    $('.categorybtn__default i').toggleClass('active2');
})
$('.department').click(function () {
    // $('.classroom').toggleClass("active1");
    console.log("test");
...
$('.post').click(function () {
    $('.like__box').toggleClass('active');
    $('.like-action').toggleClass('active');
})
//up load img
const image= document.querySelector("#image");
const image1= document.querySelector("#default-btn");
